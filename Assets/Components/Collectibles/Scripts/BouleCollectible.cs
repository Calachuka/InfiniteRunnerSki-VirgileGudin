...
public class BouleCollectible : CollectibleCM // remplacer Monobehavior ( car de base chacun de nos scripts herite de Monobehavior, mettre a la place Food (le nom de ma class mere)
{
